...
USE_MCTS  = ./bin/MCTS ./bin/MCTS_weak ./bin/MCTS_greedy ./bin/Otome ./bin/Yurika ./bin/KakeUdon ./bin/MCUdon ./bin/MClight ./bin/NegAInoido ./bin/MCSlowLight ./bin/KimeraTest
